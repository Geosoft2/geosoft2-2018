...
> To ensure a welcoming environment for all, we require everyone participating in the course to conform to the Code of Conduct given below.
> This code applies to all spaces related to the course including, but not limited to, workshop venue, emails, shared documents, and code repositories.
...
You can report Code of Conduct violations anonymously via [this form](https://docs.google.com/forms/d/e/1FAIpQLScm941UNHkt4Mja5xfFio1AMcAU2W8vGhy4-HSqCECUWBD5rg/viewform?usp=sf_link) (accessible by Daniel Nüst) or in person to ifgi staff or the student representatives.
...
_[This code of conduct is based on a CoC for ["How to teach programming (and Other Things)"](http://third-bit.com/teaching/conduct.html) by Greg Wilson, which in turn is based on that used by PyCon, which in turn is forked from a template written by the Ada Initiative and hosted on the Geek Feminism Wiki.]_